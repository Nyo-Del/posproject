...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800 mx-3" > Current User List</h1>
</div>
       ...
       <div class="col-6">
           <form action="{{ route('user#list') }}" method="GET">
               ...
               <div class="input-group mb-3 px-5 mx-5">
                   <input type="text" name="Usersearchkey" value="{{ request('Usersearchkey') }}" class="form-control rounded" placeholder="Search User" aria-label="Recipient's username" aria-describedby="button-addon2">
